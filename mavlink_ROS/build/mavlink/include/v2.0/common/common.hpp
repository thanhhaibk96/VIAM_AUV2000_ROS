...
enum class PARAM_TRANSACTION_RESPONSE : uint8_t
{
    ACCEPTED=0, /* Transaction accepted. | */
    FAILED=1, /* Transaction failed. | */
    UNSUPPORTED=2, /* Transaction unsupported. | */
    INPROGRESS=3, /* Transaction in progress. | */
};

//! PARAM_TRANSACTION_RESPONSE ENUM_END
constexpr auto PARAM_TRANSACTION_RESPONSE_ENUM_END = 4;

/** @brief Possible transport layers to set and get parameters via mavlink during a parameter transaction. */
enum class PARAM_TRANSACTION_TRANSPORT : uint8_t
{
...
enum class PARAM_TRANSACTION_ACTION : uint8_t
{
    COMMIT=0, /* Commit the current parameter transaction. | */
    CANCEL=1, /* Cancel the current parameter transaction. | */
};

//! PARAM_TRANSACTION_ACTION ENUM_END
constexpr auto PARAM_TRANSACTION_ACTION_ENUM_END = 2;
...
#include "./mavlink_msg_param_start_transaction.hpp"
#include "./mavlink_msg_param_commit_transaction.hpp"
