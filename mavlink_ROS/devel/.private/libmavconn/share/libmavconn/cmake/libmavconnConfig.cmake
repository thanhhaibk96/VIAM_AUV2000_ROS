...
if(NOT "/home/hai_bker96/VIAM_AUV2000_ROS/mavlink_ROS/src/mavros/libmavconn/include;/usr/include;/home/hai_bker96/VIAM_AUV2000_ROS/mavlink_ROS/devel/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/hai_bker96/VIAM_AUV2000_ROS/mavlink_ROS/src/mavros/libmavconn/include;/usr/include;/home/hai_bker96/VIAM_AUV2000_ROS/mavlink_ROS/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hai_bker96/VIAM_AUV2000_ROS/mavlink_ROS/src/mavros/libmavconn/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hai_bker96/VIAM_AUV2000_ROS/mavlink_ROS/devel/.private/libmavconn/lib;/home/hai_bker96/VIAM_AUV2000_ROS/mavlink_ROS/devel/lib;/opt/ros/melodic/lib)
