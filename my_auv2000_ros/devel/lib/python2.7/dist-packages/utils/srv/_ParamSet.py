...
"""autogenerated by genpy from utils/ParamSetRequest.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['string','utils/ParamValue']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.value is None:
        self.value = utils.msg.ParamValue()
    else:
      self.param_id = ''
      self.value = utils.msg.ParamValue()
...
def _get_struct_qd():
    ...
    return _struct_qd
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from utils/ParamSetResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
"""
  ...
  _slot_types = ['bool','utils/ParamValue']
