...
"""autogenerated by genpy from utils/board_arm1_stamped.msg. Do not edit."""
import codecs
import sys
...
class board_arm1_stamped(genpy.Message):
  ...
  _type = "utils/board_arm1_stamped"
...
"""
  ...
  _slot_types = ['std_msgs/Header','utils/motor_stamped','utils/motor_stamped','utils/bms_stamped','utils/altimeter_stamped','utils/anti_rolling_stamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.pistol_status is None:
        self.pistol_status = utils.msg.motor_stamped()
      if self.mass_shifter_status is None:
        self.mass_shifter_status = utils.msg.motor_stamped()
      if self.bms_status is None:
        self.bms_status = utils.msg.bms_stamped()
      if self.altimeter_status is None:
        self.altimeter_status = utils.msg.altimeter_stamped()
