...
"""autogenerated by genpy from std_msgs_stamped/UInt64MultiArrayStamped.msg. Do not edit."""
import codecs
import sys
...
class UInt64MultiArrayStamped(genpy.Message):
  _md5sum = "162c51aac0ff084a0daa48aa9cdb4e79"
  _type = "std_msgs_stamped/UInt64MultiArrayStamped"
...
uint32 stride  # stride of given dimension"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/MultiArrayLayout','uint64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UInt64MultiArrayStamped, self).__init__(*args, **kwds)
