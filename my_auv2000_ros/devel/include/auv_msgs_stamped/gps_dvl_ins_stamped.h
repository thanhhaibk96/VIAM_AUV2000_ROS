// Generated by gencpp from file auv_msgs_stamped/gps_dvl_ins_stamped.msg
// DO NOT EDIT!


#ifndef AUV_MSGS_STAMPED_MESSAGE_GPS_DVL_INS_STAMPED_H
#define AUV_MSGS_STAMPED_MESSAGE_GPS_DVL_INS_STAMPED_H
...
struct gps_dvl_ins_stamped_
{
  ...
  typedef boost::shared_ptr< ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> const> ConstPtr;

}; // struct gps_dvl_ins_stamped_

typedef ::auv_msgs_stamped::gps_dvl_ins_stamped_<std::allocator<void> > gps_dvl_ins_stamped;

typedef boost::shared_ptr< ::auv_msgs_stamped::gps_dvl_ins_stamped > gps_dvl_ins_stampedPtr;
typedef boost::shared_ptr< ::auv_msgs_stamped::gps_dvl_ins_stamped const> gps_dvl_ins_stampedConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator1> & lhs, const ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> >
{
  ...
  static const char* value(const ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xaf19aa78b3d90a13ULL;
  static const uint64_t static_value2 = 0xc41e03b9a86c6e4fULL;
};

template<class ContainerAllocator>
struct DataType< ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::auv_msgs_stamped::gps_dvl_ins_stamped_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // AUV_MSGS_STAMPED_MESSAGE_GPS_DVL_INS_STAMPED_H
