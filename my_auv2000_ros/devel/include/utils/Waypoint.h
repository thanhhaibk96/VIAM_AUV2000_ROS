// Generated by gencpp from file utils/Waypoint.msg
// DO NOT EDIT!


#ifndef UTILS_MESSAGE_WAYPOINT_H
#define UTILS_MESSAGE_WAYPOINT_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::utils::Waypoint_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::utils::Waypoint_<ContainerAllocator> const> ConstPtr;

}; // struct Waypoint_

typedef ::utils::Waypoint_<std::allocator<void> > Waypoint;

typedef boost::shared_ptr< ::utils::Waypoint > WaypointPtr;
typedef boost::shared_ptr< ::utils::Waypoint const> WaypointConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::utils::Waypoint_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::utils::Waypoint_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::utils::Waypoint_<ContainerAllocator1> & lhs, const ::utils::Waypoint_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::utils::Waypoint_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::utils::Waypoint_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::utils::Waypoint_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::utils::Waypoint_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::utils::Waypoint_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::utils::Waypoint_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::utils::Waypoint_<ContainerAllocator> >
{
  ...
  static const char* value(const ::utils::Waypoint_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7a0d2b53dcd6b7afULL;
  static const uint64_t static_value2 = 0xf0aa748703e85e92ULL;
};

template<class ContainerAllocator>
struct DataType< ::utils::Waypoint_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::utils::Waypoint_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Waypoint.msg\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::utils::Waypoint_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::utils::Waypoint_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::utils::Waypoint_<ContainerAllocator>& v)
  {
    s << indent << "frame: ";
...
#endif // UTILS_MESSAGE_WAYPOINT_H
