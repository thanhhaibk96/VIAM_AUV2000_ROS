// Generated by gencpp from file utils/joystick_stamped.msg
// DO NOT EDIT!


#ifndef UTILS_MESSAGE_JOYSTICK_STAMPED_H
#define UTILS_MESSAGE_JOYSTICK_STAMPED_H
...
struct joystick_stamped_
{
  ...
  typedef boost::shared_ptr< ::utils::joystick_stamped_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::utils::joystick_stamped_<ContainerAllocator> const> ConstPtr;

}; // struct joystick_stamped_

typedef ::utils::joystick_stamped_<std::allocator<void> > joystick_stamped;

typedef boost::shared_ptr< ::utils::joystick_stamped > joystick_stampedPtr;
typedef boost::shared_ptr< ::utils::joystick_stamped const> joystick_stampedConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::utils::joystick_stamped_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::utils::joystick_stamped_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::utils::joystick_stamped_<ContainerAllocator1> & lhs, const ::utils::joystick_stamped_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::utils::joystick_stamped_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::utils::joystick_stamped_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::utils::joystick_stamped_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::utils::joystick_stamped_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::utils::joystick_stamped_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::utils::joystick_stamped_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::utils::joystick_stamped_<ContainerAllocator> >
{
  ...
  static const char* value(const ::utils::joystick_stamped_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8f06eae7095797a9ULL;
  static const uint64_t static_value2 = 0xbb9cf16fda02c08eULL;
};

template<class ContainerAllocator>
struct DataType< ::utils::joystick_stamped_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::utils::joystick_stamped_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::utils::joystick_stamped_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::utils::joystick_stamped_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::utils::joystick_stamped_<ContainerAllocator>& v)
  {
    s << indent << "arrow_left: ";
...
#endif // UTILS_MESSAGE_JOYSTICK_STAMPED_H
