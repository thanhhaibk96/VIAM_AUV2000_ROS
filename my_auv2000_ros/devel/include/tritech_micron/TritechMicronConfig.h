...
bool operator==(const ::tritech_micron::TritechMicronConfig_<ContainerAllocator1> & lhs, const ::tritech_micron::TritechMicronConfig_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.inverted == rhs.inverted &&
    lhs.continuous == rhs.continuous &&
    lhs.scanright == rhs.scanright &&
    lhs.adc8on == rhs.adc8on &&
    lhs.gain == rhs.gain &&
    lhs.ad_low == rhs.ad_low &&
    lhs.ad_high == rhs.ad_high &&
    lhs.left_limit == rhs.left_limit &&
    lhs.right_limit == rhs.right_limit &&
    lhs.range == rhs.range &&
    lhs.nbins == rhs.nbins &&
    lhs.step == rhs.step;
}
