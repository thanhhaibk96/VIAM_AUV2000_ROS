...
class UInt64MultiArrayStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new UInt64MultiArrayStamped(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new UInt64MultiArrayStamped(null);
...
module.exports = UInt64MultiArrayStamped;
