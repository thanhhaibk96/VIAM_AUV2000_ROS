...
class UInt8MultiArrayStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new UInt8MultiArrayStamped(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new UInt8MultiArrayStamped(null);
...
module.exports = UInt8MultiArrayStamped;
