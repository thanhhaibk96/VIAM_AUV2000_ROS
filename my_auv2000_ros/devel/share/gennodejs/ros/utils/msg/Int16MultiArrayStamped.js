...
class Int16MultiArrayStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Int16MultiArrayStamped(null);
  ...
  static datatype() {
    ...
    return 'utils/Int16MultiArrayStamped';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Int16MultiArrayStamped(null);
...
module.exports = Int16MultiArrayStamped;
