...
class Int8MultiArrayStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Int8MultiArrayStamped(null);
  ...
  static datatype() {
    ...
    return 'utils/Int8MultiArrayStamped';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Int8MultiArrayStamped(null);
...
module.exports = Int8MultiArrayStamped;
