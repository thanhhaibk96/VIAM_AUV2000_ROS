...
class Int64MultiArrayStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Int64MultiArrayStamped(null);
  ...
  static datatype() {
    ...
    return 'utils/Int64MultiArrayStamped';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Int64MultiArrayStamped(null);
...
module.exports = Int64MultiArrayStamped;
