...
class ByteMultiArrayStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ByteMultiArrayStamped(null);
  ...
  static datatype() {
    ...
    return 'utils/ByteMultiArrayStamped';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ByteMultiArrayStamped(null);
...
module.exports = ByteMultiArrayStamped;
