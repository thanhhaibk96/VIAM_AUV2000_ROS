...
class UInt16MultiArrayStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new UInt16MultiArrayStamped(null);
  ...
  static datatype() {
    ...
    return 'utils/UInt16MultiArrayStamped';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new UInt16MultiArrayStamped(null);
...
module.exports = UInt16MultiArrayStamped;
