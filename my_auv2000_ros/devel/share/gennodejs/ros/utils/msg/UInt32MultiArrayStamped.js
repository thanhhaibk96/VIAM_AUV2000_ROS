...
class UInt32MultiArrayStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new UInt32MultiArrayStamped(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new UInt32MultiArrayStamped(null);
...
module.exports = UInt32MultiArrayStamped;
