...
if("TRUE" STREQUAL "TRUE")
  set(navigator_SOURCE_PREFIX /home/hai_bker96/VIAM_AUV2000_ROS/my_auv2000_ros/src/navigator)
  set(navigator_DEVEL_PREFIX /home/hai_bker96/VIAM_AUV2000_ROS/my_auv2000_ros/devel)
  ...
  set(navigator_INSTALL_PREFIX /home/hai_bker96/VIAM_AUV2000_ROS/my_auv2000_ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hai_bker96/VIAM_AUV2000_ROS/my_auv2000_ros/src/navigator/${idir}'.  ${_report}")
    endif()
