...
(cl:defmethod cl:initialize-instance :after ((m <SetMode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-srv:<SetMode-request> is deprecated: use utils-srv:SetMode-request instead.")))

(cl:ensure-generic-function 'base_mode-val :lambda-list '(m))
(cl:defmethod base_mode-val ((m <SetMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:base_mode-val is deprecated.  Use utils-srv:base_mode instead.")
  (base_mode m))

(cl:ensure-generic-function 'custom_mode-val :lambda-list '(m))
(cl:defmethod custom_mode-val ((m <SetMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:custom_mode-val is deprecated.  Use utils-srv:custom_mode instead.")
  (custom_mode m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetMode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-srv:<SetMode-response> is deprecated: use utils-srv:SetMode-response instead.")))

(cl:ensure-generic-function 'mode_sent-val :lambda-list '(m))
(cl:defmethod mode_sent-val ((m <SetMode-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:mode_sent-val is deprecated.  Use utils-srv:mode_sent instead.")
  (mode_sent m))
