...
(cl:defmethod cl:initialize-instance :after ((m <CommandLong-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandLong-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-srv:<CommandLong-request> is deprecated: use utils-srv:CommandLong-request instead.")))

(cl:ensure-generic-function 'broadcast-val :lambda-list '(m))
(cl:defmethod broadcast-val ((m <CommandLong-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:broadcast-val is deprecated.  Use utils-srv:broadcast instead.")
  (broadcast m))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <CommandLong-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:command-val is deprecated.  Use utils-srv:command instead.")
  (command m))

(cl:ensure-generic-function 'confirmation-val :lambda-list '(m))
(cl:defmethod confirmation-val ((m <CommandLong-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:confirmation-val is deprecated.  Use utils-srv:confirmation instead.")
  (confirmation m))

(cl:ensure-generic-function 'param1-val :lambda-list '(m))
(cl:defmethod param1-val ((m <CommandLong-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:param1-val is deprecated.  Use utils-srv:param1 instead.")
  (param1 m))

(cl:ensure-generic-function 'param2-val :lambda-list '(m))
(cl:defmethod param2-val ((m <CommandLong-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:param2-val is deprecated.  Use utils-srv:param2 instead.")
  (param2 m))

(cl:ensure-generic-function 'param3-val :lambda-list '(m))
(cl:defmethod param3-val ((m <CommandLong-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:param3-val is deprecated.  Use utils-srv:param3 instead.")
  (param3 m))

(cl:ensure-generic-function 'param4-val :lambda-list '(m))
(cl:defmethod param4-val ((m <CommandLong-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:param4-val is deprecated.  Use utils-srv:param4 instead.")
  (param4 m))

(cl:ensure-generic-function 'param5-val :lambda-list '(m))
(cl:defmethod param5-val ((m <CommandLong-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:param5-val is deprecated.  Use utils-srv:param5 instead.")
  (param5 m))

(cl:ensure-generic-function 'param6-val :lambda-list '(m))
(cl:defmethod param6-val ((m <CommandLong-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:param6-val is deprecated.  Use utils-srv:param6 instead.")
  (param6 m))

(cl:ensure-generic-function 'param7-val :lambda-list '(m))
(cl:defmethod param7-val ((m <CommandLong-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:param7-val is deprecated.  Use utils-srv:param7 instead.")
  (param7 m))
...
(cl:defmethod cl:initialize-instance :after ((m <CommandLong-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandLong-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-srv:<CommandLong-response> is deprecated: use utils-srv:CommandLong-response instead.")))
...
(cl:defmethod result-val ((m <CommandLong-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:result-val is deprecated.  Use utils-srv:result instead.")
  (result m))
