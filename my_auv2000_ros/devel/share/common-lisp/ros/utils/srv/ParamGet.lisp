...
(cl:defmethod cl:initialize-instance :after ((m <ParamGet-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ParamGet-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-srv:<ParamGet-request> is deprecated: use utils-srv:ParamGet-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <ParamGet-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ParamGet-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-srv:<ParamGet-response> is deprecated: use utils-srv:ParamGet-response instead.")))
