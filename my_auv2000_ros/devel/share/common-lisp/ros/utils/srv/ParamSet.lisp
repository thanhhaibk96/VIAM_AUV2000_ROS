...
(cl:defclass <ParamSet-request> (roslisp-msg-protocol:ros-message)
  ((param_id
   ...
   (value
    :reader value
    :initarg :value
    :type utils-msg:ParamValue
    :initform (cl:make-instance 'utils-msg:ParamValue)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ParamSet-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ParamSet-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-srv:<ParamSet-request> is deprecated: use utils-srv:ParamSet-request instead.")))

(cl:ensure-generic-function 'param_id-val :lambda-list '(m))
(cl:defmethod param_id-val ((m <ParamSet-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:param_id-val is deprecated.  Use utils-srv:param_id instead.")
  (param_id m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <ParamSet-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:value-val is deprecated.  Use utils-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ParamSet-request>)))
  ...
  (cl:format cl:nil "# Request set parameter value~%~%string param_id~%ParamValue value~%~%================================================================================~%MSG: utils/ParamValue~%# Parameter value storage type.~%#~%# Integer and float fields:~%#~%# if integer != 0: it is integer value~%# else if real != 0.0: it is float value~%# else: it is zero.~%~%int64 integer~%float64 real~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ParamSet-request)))
  "Returns full string definition for message of type 'ParamSet-request"
  (cl:format cl:nil "# Request set parameter value~%~%string param_id~%ParamValue value~%~%================================================================================~%MSG: utils/ParamValue~%# Parameter value storage type.~%#~%# Integer and float fields:~%#~%# if integer != 0: it is integer value~%# else if real != 0.0: it is float value~%# else: it is zero.~%~%int64 integer~%float64 real~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <ParamSet-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ParamSet-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-srv:<ParamSet-response> is deprecated: use utils-srv:ParamSet-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ParamSet-response>)))
  ...
  (cl:format cl:nil "bool success~%utils/ParamValue value~%~%~%================================================================================~%MSG: utils/ParamValue~%# Parameter value storage type.~%#~%# Integer and float fields:~%#~%# if integer != 0: it is integer value~%# else if real != 0.0: it is float value~%# else: it is zero.~%~%int64 integer~%float64 real~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ParamSet-response)))
  "Returns full string definition for message of type 'ParamSet-response"
  (cl:format cl:nil "bool success~%utils/ParamValue value~%~%~%================================================================================~%MSG: utils/ParamValue~%# Parameter value storage type.~%#~%# Integer and float fields:~%#~%# if integer != 0: it is integer value~%# else if real != 0.0: it is float value~%# else: it is zero.~%~%int64 integer~%float64 real~%~%~%"))
