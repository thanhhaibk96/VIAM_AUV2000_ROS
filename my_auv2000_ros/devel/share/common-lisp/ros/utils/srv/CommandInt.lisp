...
(cl:defmethod cl:initialize-instance :after ((m <CommandInt-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandInt-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-srv:<CommandInt-request> is deprecated: use utils-srv:CommandInt-request instead.")))
...
(cl:defmethod frame-val ((m <CommandInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:frame-val is deprecated.  Use utils-srv:frame instead.")
  (frame m))
...
(cl:defmethod current-val ((m <CommandInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:current-val is deprecated.  Use utils-srv:current instead.")
  (current m))

(cl:ensure-generic-function 'autocontinue-val :lambda-list '(m))
(cl:defmethod autocontinue-val ((m <CommandInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:autocontinue-val is deprecated.  Use utils-srv:autocontinue instead.")
  (autocontinue m))
...
(cl:defmethod z-val ((m <CommandInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-srv:z-val is deprecated.  Use utils-srv:z instead.")
  (z m))
...
(cl:defmethod cl:initialize-instance :after ((m <CommandInt-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandInt-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-srv:<CommandInt-response> is deprecated: use utils-srv:CommandInt-response instead.")))
