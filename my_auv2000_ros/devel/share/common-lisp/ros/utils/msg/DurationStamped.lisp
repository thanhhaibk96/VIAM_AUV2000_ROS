...
(cl:defmethod cl:initialize-instance :after ((m <DurationStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DurationStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-msg:<DurationStamped> is deprecated: use utils-msg:DurationStamped instead.")))
