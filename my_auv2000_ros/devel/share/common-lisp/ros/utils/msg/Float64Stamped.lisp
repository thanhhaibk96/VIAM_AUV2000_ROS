...
(cl:defmethod cl:initialize-instance :after ((m <Float64Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float64Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-msg:<Float64Stamped> is deprecated: use utils-msg:Float64Stamped instead.")))
