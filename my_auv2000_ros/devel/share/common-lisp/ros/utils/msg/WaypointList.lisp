...
(cl:defclass <WaypointList> (roslisp-msg-protocol:ros-message)
  ((current_seq
   ...
   (waypoints
    :reader waypoints
    :initarg :waypoints
    :type (cl:vector utils-msg:Waypoint)
   :initform (cl:make-array 0 :element-type 'utils-msg:Waypoint :initial-element (cl:make-instance 'utils-msg:Waypoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <WaypointList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-msg:<WaypointList> is deprecated: use utils-msg:WaypointList instead.")))

(cl:ensure-generic-function 'current_seq-val :lambda-list '(m))
(cl:defmethod current_seq-val ((m <WaypointList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:current_seq-val is deprecated.  Use utils-msg:current_seq instead.")
  (current_seq m))

(cl:ensure-generic-function 'waypoints-val :lambda-list '(m))
(cl:defmethod waypoints-val ((m <WaypointList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:waypoints-val is deprecated.  Use utils-msg:waypoints instead.")
  (waypoints m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WaypointList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'waypoints)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'utils-msg:Waypoint))
