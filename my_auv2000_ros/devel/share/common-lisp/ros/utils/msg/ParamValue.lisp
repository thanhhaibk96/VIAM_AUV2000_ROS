...
(cl:defmethod cl:initialize-instance :after ((m <ParamValue>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ParamValue)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-msg:<ParamValue> is deprecated: use utils-msg:ParamValue instead.")))

(cl:ensure-generic-function 'integer-val :lambda-list '(m))
(cl:defmethod integer-val ((m <ParamValue>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:integer-val is deprecated.  Use utils-msg:integer instead.")
  (integer m))

(cl:ensure-generic-function 'real-val :lambda-list '(m))
(cl:defmethod real-val ((m <ParamValue>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:real-val is deprecated.  Use utils-msg:real instead.")
  (real m))
