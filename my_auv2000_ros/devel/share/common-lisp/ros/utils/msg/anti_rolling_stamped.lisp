...
(cl:defmethod cl:initialize-instance :after ((m <anti_rolling_stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'anti_rolling_stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-msg:<anti_rolling_stamped> is deprecated: use utils-msg:anti_rolling_stamped instead.")))

(cl:ensure-generic-function 'kp-val :lambda-list '(m))
(cl:defmethod kp-val ((m <anti_rolling_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:kp-val is deprecated.  Use utils-msg:kp instead.")
  (kp m))

(cl:ensure-generic-function 'ki-val :lambda-list '(m))
(cl:defmethod ki-val ((m <anti_rolling_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ki-val is deprecated.  Use utils-msg:ki instead.")
  (ki m))

(cl:ensure-generic-function 'kd-val :lambda-list '(m))
(cl:defmethod kd-val ((m <anti_rolling_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:kd-val is deprecated.  Use utils-msg:kd instead.")
  (kd m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <anti_rolling_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:angle-val is deprecated.  Use utils-msg:angle instead.")
  (angle m))
