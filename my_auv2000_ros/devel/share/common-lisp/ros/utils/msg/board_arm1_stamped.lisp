...
(cl:defclass <board_arm1_stamped> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (pistol_status
    ...
    :type utils-msg:motor_stamped
    :initform (cl:make-instance 'utils-msg:motor_stamped))
   (mass_shifter_status
   ...
   (bms_status
    :reader bms_status
    :initarg :bms_status
    :type utils-msg:bms_stamped
    :initform (cl:make-instance 'utils-msg:bms_stamped))
   (altimeter_status
    :reader altimeter_status
    :initarg :altimeter_status
    :type utils-msg:altimeter_stamped
    :initform (cl:make-instance 'utils-msg:altimeter_stamped))
   (roll_motor_status
    :reader roll_motor_status
    :initarg :roll_motor_status
    :type utils-msg:anti_rolling_stamped
    :initform (cl:make-instance 'utils-msg:anti_rolling_stamped)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <board_arm1_stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'board_arm1_stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-msg:<board_arm1_stamped> is deprecated: use utils-msg:board_arm1_stamped instead.")))
...
(cl:defmethod pistol_status-val ((m <board_arm1_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:pistol_status-val is deprecated.  Use utils-msg:pistol_status instead.")
  (pistol_status m))
...
(cl:defmethod mass_shifter_status-val ((m <board_arm1_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:mass_shifter_status-val is deprecated.  Use utils-msg:mass_shifter_status instead.")
...
(cl:defmethod bms_status-val ((m <board_arm1_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:bms_status-val is deprecated.  Use utils-msg:bms_status instead.")
  (bms_status m))

(cl:ensure-generic-function 'altimeter_status-val :lambda-list '(m))
(cl:defmethod altimeter_status-val ((m <board_arm1_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:altimeter_status-val is deprecated.  Use utils-msg:altimeter_status instead.")
  (altimeter_status m))

(cl:ensure-generic-function 'roll_motor_status-val :lambda-list '(m))
(cl:defmethod roll_motor_status-val ((m <board_arm1_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:roll_motor_status-val is deprecated.  Use utils-msg:roll_motor_status instead.")
  (roll_motor_status m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<board_arm1_stamped>)))
  ...
  (cl:format cl:nil "Header header~%motor_stamped pistol_status~%motor_stamped mass_shifter_status~%bms_stamped bms_status~%altimeter_stamped altimeter_status~%anti_rolling_stamped roll_motor_status~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: utils/motor_stamped~%float32 position~%float32 motor_duty~%float32 motor_temp_on_chip~%float32 motor_temp_ambient~%float32 motor_current~%float32 motor_rspeed~%float32 motor_dspeed~%~%================================================================================~%MSG: utils/bms_stamped~%float32 batteryTotal~%float32 batteryCapacity~%float32 batteryUsed~%float32 batteryPercentage~%float32 batteryCurrent~%float32 baterryVoltage~%~%================================================================================~%MSG: utils/altimeter_stamped~%float32 alt_in_metres~%float32 alt_in_fathoms~%float32 alt_in_feet~%~%================================================================================~%MSG: utils/anti_rolling_stamped~%float32 kp~%float32 ki~%float32 kd~%float32 angle~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'board_arm1_stamped)))
  "Returns full string definition for message of type 'board_arm1_stamped"
  (cl:format cl:nil "Header header~%motor_stamped pistol_status~%motor_stamped mass_shifter_status~%bms_stamped bms_status~%altimeter_stamped altimeter_status~%anti_rolling_stamped roll_motor_status~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: utils/motor_stamped~%float32 position~%float32 motor_duty~%float32 motor_temp_on_chip~%float32 motor_temp_ambient~%float32 motor_current~%float32 motor_rspeed~%float32 motor_dspeed~%~%================================================================================~%MSG: utils/bms_stamped~%float32 batteryTotal~%float32 batteryCapacity~%float32 batteryUsed~%float32 batteryPercentage~%float32 batteryCurrent~%float32 baterryVoltage~%~%================================================================================~%MSG: utils/altimeter_stamped~%float32 alt_in_metres~%float32 alt_in_fathoms~%float32 alt_in_feet~%~%================================================================================~%MSG: utils/anti_rolling_stamped~%float32 kp~%float32 ki~%float32 kd~%float32 angle~%~%~%"))
