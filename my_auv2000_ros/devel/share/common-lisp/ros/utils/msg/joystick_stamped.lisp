...
(cl:defmethod cl:initialize-instance :after ((m <joystick_stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'joystick_stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-msg:<joystick_stamped> is deprecated: use utils-msg:joystick_stamped instead.")))

(cl:ensure-generic-function 'arrow_left-val :lambda-list '(m))
(cl:defmethod arrow_left-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:arrow_left-val is deprecated.  Use utils-msg:arrow_left instead.")
  (arrow_left m))

(cl:ensure-generic-function 'arrow_right-val :lambda-list '(m))
(cl:defmethod arrow_right-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:arrow_right-val is deprecated.  Use utils-msg:arrow_right instead.")
  (arrow_right m))

(cl:ensure-generic-function 'mass_shifter_up-val :lambda-list '(m))
(cl:defmethod mass_shifter_up-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:mass_shifter_up-val is deprecated.  Use utils-msg:mass_shifter_up instead.")
  (mass_shifter_up m))

(cl:ensure-generic-function 'mass_shifter_down-val :lambda-list '(m))
(cl:defmethod mass_shifter_down-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:mass_shifter_down-val is deprecated.  Use utils-msg:mass_shifter_down instead.")
  (mass_shifter_down m))

(cl:ensure-generic-function 'button_x-val :lambda-list '(m))
(cl:defmethod button_x-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:button_x-val is deprecated.  Use utils-msg:button_x instead.")
  (button_x m))

(cl:ensure-generic-function 'pistol_up-val :lambda-list '(m))
(cl:defmethod pistol_up-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:pistol_up-val is deprecated.  Use utils-msg:pistol_up instead.")
  (pistol_up m))

(cl:ensure-generic-function 'button_b-val :lambda-list '(m))
(cl:defmethod button_b-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:button_b-val is deprecated.  Use utils-msg:button_b instead.")
  (button_b m))

(cl:ensure-generic-function 'pistol_down-val :lambda-list '(m))
(cl:defmethod pistol_down-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:pistol_down-val is deprecated.  Use utils-msg:pistol_down instead.")
  (pistol_down m))

(cl:ensure-generic-function 'button_back-val :lambda-list '(m))
(cl:defmethod button_back-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:button_back-val is deprecated.  Use utils-msg:button_back instead.")
  (button_back m))

(cl:ensure-generic-function 'button_start-val :lambda-list '(m))
(cl:defmethod button_start-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:button_start-val is deprecated.  Use utils-msg:button_start instead.")
  (button_start m))

(cl:ensure-generic-function 'bhat_lt-val :lambda-list '(m))
(cl:defmethod bhat_lt-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:bhat_lt-val is deprecated.  Use utils-msg:bhat_lt instead.")
  (bhat_lt m))

(cl:ensure-generic-function 'bhat_lb-val :lambda-list '(m))
(cl:defmethod bhat_lb-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:bhat_lb-val is deprecated.  Use utils-msg:bhat_lb instead.")
  (bhat_lb m))

(cl:ensure-generic-function 'bhat_rt-val :lambda-list '(m))
(cl:defmethod bhat_rt-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:bhat_rt-val is deprecated.  Use utils-msg:bhat_rt instead.")
  (bhat_rt m))

(cl:ensure-generic-function 'bhat_rb-val :lambda-list '(m))
(cl:defmethod bhat_rb-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:bhat_rb-val is deprecated.  Use utils-msg:bhat_rb instead.")
  (bhat_rb m))

(cl:ensure-generic-function 'rudder-val :lambda-list '(m))
(cl:defmethod rudder-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:rudder-val is deprecated.  Use utils-msg:rudder instead.")
  (rudder m))

(cl:ensure-generic-function 'thruster-val :lambda-list '(m))
(cl:defmethod thruster-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:thruster-val is deprecated.  Use utils-msg:thruster instead.")
  (thruster m))
...
(cl:defmethod r-val ((m <joystick_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:r-val is deprecated.  Use utils-msg:r instead.")
  (r m))
