...
(cl:defmethod cl:initialize-instance :after ((m <altimeter_stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'altimeter_stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-msg:<altimeter_stamped> is deprecated: use utils-msg:altimeter_stamped instead.")))

(cl:ensure-generic-function 'alt_in_metres-val :lambda-list '(m))
(cl:defmethod alt_in_metres-val ((m <altimeter_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:alt_in_metres-val is deprecated.  Use utils-msg:alt_in_metres instead.")
  (alt_in_metres m))

(cl:ensure-generic-function 'alt_in_fathoms-val :lambda-list '(m))
(cl:defmethod alt_in_fathoms-val ((m <altimeter_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:alt_in_fathoms-val is deprecated.  Use utils-msg:alt_in_fathoms instead.")
  (alt_in_fathoms m))

(cl:ensure-generic-function 'alt_in_feet-val :lambda-list '(m))
(cl:defmethod alt_in_feet-val ((m <altimeter_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:alt_in_feet-val is deprecated.  Use utils-msg:alt_in_feet instead.")
  (alt_in_feet m))
