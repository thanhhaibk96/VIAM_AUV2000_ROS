...
(cl:defmethod cl:initialize-instance :after ((m <gps_dvl_ins_stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gps_dvl_ins_stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-msg:<gps_dvl_ins_stamped> is deprecated: use utils-msg:gps_dvl_ins_stamped instead.")))
...
(cl:defmethod sample_count-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:sample_count-val is deprecated.  Use utils-msg:sample_count instead.")
  (sample_count m))

(cl:ensure-generic-function 'ekf_roll-val :lambda-list '(m))
(cl:defmethod ekf_roll-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ekf_roll-val is deprecated.  Use utils-msg:ekf_roll instead.")
  (ekf_roll m))

(cl:ensure-generic-function 'ekf_pitch-val :lambda-list '(m))
(cl:defmethod ekf_pitch-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ekf_pitch-val is deprecated.  Use utils-msg:ekf_pitch instead.")
  (ekf_pitch m))

(cl:ensure-generic-function 'ekf_yaw-val :lambda-list '(m))
(cl:defmethod ekf_yaw-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ekf_yaw-val is deprecated.  Use utils-msg:ekf_yaw instead.")
  (ekf_yaw m))

(cl:ensure-generic-function 'ekf_lat-val :lambda-list '(m))
(cl:defmethod ekf_lat-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ekf_lat-val is deprecated.  Use utils-msg:ekf_lat instead.")
  (ekf_lat m))

(cl:ensure-generic-function 'ekf_lon-val :lambda-list '(m))
(cl:defmethod ekf_lon-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ekf_lon-val is deprecated.  Use utils-msg:ekf_lon instead.")
  (ekf_lon m))

(cl:ensure-generic-function 'ekf_alt-val :lambda-list '(m))
(cl:defmethod ekf_alt-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ekf_alt-val is deprecated.  Use utils-msg:ekf_alt instead.")
  (ekf_alt m))

(cl:ensure-generic-function 'ekf_vN-val :lambda-list '(m))
(cl:defmethod ekf_vN-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ekf_vN-val is deprecated.  Use utils-msg:ekf_vN instead.")
  (ekf_vN m))

(cl:ensure-generic-function 'ekf_vE-val :lambda-list '(m))
(cl:defmethod ekf_vE-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ekf_vE-val is deprecated.  Use utils-msg:ekf_vE instead.")
  (ekf_vE m))

(cl:ensure-generic-function 'ekf_vD-val :lambda-list '(m))
(cl:defmethod ekf_vD-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ekf_vD-val is deprecated.  Use utils-msg:ekf_vD instead.")
  (ekf_vD m))

(cl:ensure-generic-function 'ekf_vX-val :lambda-list '(m))
(cl:defmethod ekf_vX-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ekf_vX-val is deprecated.  Use utils-msg:ekf_vX instead.")
  (ekf_vX m))

(cl:ensure-generic-function 'ekf_vY-val :lambda-list '(m))
(cl:defmethod ekf_vY-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ekf_vY-val is deprecated.  Use utils-msg:ekf_vY instead.")
  (ekf_vY m))

(cl:ensure-generic-function 'ekf_vZ-val :lambda-list '(m))
(cl:defmethod ekf_vZ-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ekf_vZ-val is deprecated.  Use utils-msg:ekf_vZ instead.")
  (ekf_vZ m))

(cl:ensure-generic-function 'rad_gyro_X-val :lambda-list '(m))
(cl:defmethod rad_gyro_X-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:rad_gyro_X-val is deprecated.  Use utils-msg:rad_gyro_X instead.")
  (rad_gyro_X m))

(cl:ensure-generic-function 'rad_gyro_Y-val :lambda-list '(m))
(cl:defmethod rad_gyro_Y-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:rad_gyro_Y-val is deprecated.  Use utils-msg:rad_gyro_Y instead.")
  (rad_gyro_Y m))

(cl:ensure-generic-function 'rad_gyro_Z-val :lambda-list '(m))
(cl:defmethod rad_gyro_Z-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:rad_gyro_Z-val is deprecated.  Use utils-msg:rad_gyro_Z instead.")
  (rad_gyro_Z m))

(cl:ensure-generic-function 'angular_acc_X-val :lambda-list '(m))
(cl:defmethod angular_acc_X-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:angular_acc_X-val is deprecated.  Use utils-msg:angular_acc_X instead.")
  (angular_acc_X m))

(cl:ensure-generic-function 'angular_acc_Y-val :lambda-list '(m))
(cl:defmethod angular_acc_Y-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:angular_acc_Y-val is deprecated.  Use utils-msg:angular_acc_Y instead.")
  (angular_acc_Y m))

(cl:ensure-generic-function 'angular_acc_Z-val :lambda-list '(m))
(cl:defmethod angular_acc_Z-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:angular_acc_Z-val is deprecated.  Use utils-msg:angular_acc_Z instead.")
  (angular_acc_Z m))

(cl:ensure-generic-function 'alt_DVL-val :lambda-list '(m))
(cl:defmethod alt_DVL-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:alt_DVL-val is deprecated.  Use utils-msg:alt_DVL instead.")
  (alt_DVL m))

(cl:ensure-generic-function 'dvl_error_code-val :lambda-list '(m))
(cl:defmethod dvl_error_code-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:dvl_error_code-val is deprecated.  Use utils-msg:dvl_error_code instead.")
  (dvl_error_code m))

(cl:ensure-generic-function 'flag_to_check-val :lambda-list '(m))
(cl:defmethod flag_to_check-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:flag_to_check-val is deprecated.  Use utils-msg:flag_to_check instead.")
  (flag_to_check m))

(cl:ensure-generic-function 'imu_deg_gyro_X-val :lambda-list '(m))
(cl:defmethod imu_deg_gyro_X-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:imu_deg_gyro_X-val is deprecated.  Use utils-msg:imu_deg_gyro_X instead.")
  (imu_deg_gyro_X m))

(cl:ensure-generic-function 'imu_deg_gyro_Y-val :lambda-list '(m))
(cl:defmethod imu_deg_gyro_Y-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:imu_deg_gyro_Y-val is deprecated.  Use utils-msg:imu_deg_gyro_Y instead.")
  (imu_deg_gyro_Y m))

(cl:ensure-generic-function 'imu_deg_gyro_Z-val :lambda-list '(m))
(cl:defmethod imu_deg_gyro_Z-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:imu_deg_gyro_Z-val is deprecated.  Use utils-msg:imu_deg_gyro_Z instead.")
  (imu_deg_gyro_Z m))

(cl:ensure-generic-function 'imu_mag_X-val :lambda-list '(m))
(cl:defmethod imu_mag_X-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:imu_mag_X-val is deprecated.  Use utils-msg:imu_mag_X instead.")
  (imu_mag_X m))

(cl:ensure-generic-function 'imu_mag_Y-val :lambda-list '(m))
(cl:defmethod imu_mag_Y-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:imu_mag_Y-val is deprecated.  Use utils-msg:imu_mag_Y instead.")
  (imu_mag_Y m))

(cl:ensure-generic-function 'imu_mag_Z-val :lambda-list '(m))
(cl:defmethod imu_mag_Z-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:imu_mag_Z-val is deprecated.  Use utils-msg:imu_mag_Z instead.")
  (imu_mag_Z m))

(cl:ensure-generic-function 'imu_acc_X-val :lambda-list '(m))
(cl:defmethod imu_acc_X-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:imu_acc_X-val is deprecated.  Use utils-msg:imu_acc_X instead.")
  (imu_acc_X m))

(cl:ensure-generic-function 'imu_acc_Y-val :lambda-list '(m))
(cl:defmethod imu_acc_Y-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:imu_acc_Y-val is deprecated.  Use utils-msg:imu_acc_Y instead.")
  (imu_acc_Y m))

(cl:ensure-generic-function 'imu_acc_Z-val :lambda-list '(m))
(cl:defmethod imu_acc_Z-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:imu_acc_Z-val is deprecated.  Use utils-msg:imu_acc_Z instead.")
  (imu_acc_Z m))

(cl:ensure-generic-function 'gps_lat-val :lambda-list '(m))
(cl:defmethod gps_lat-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:gps_lat-val is deprecated.  Use utils-msg:gps_lat instead.")
  (gps_lat m))

(cl:ensure-generic-function 'gps_lon-val :lambda-list '(m))
(cl:defmethod gps_lon-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:gps_lon-val is deprecated.  Use utils-msg:gps_lon instead.")
  (gps_lon m))

(cl:ensure-generic-function 'gps_alt-val :lambda-list '(m))
(cl:defmethod gps_alt-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:gps_alt-val is deprecated.  Use utils-msg:gps_alt instead.")
  (gps_alt m))

(cl:ensure-generic-function 'gps_vN-val :lambda-list '(m))
(cl:defmethod gps_vN-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:gps_vN-val is deprecated.  Use utils-msg:gps_vN instead.")
  (gps_vN m))

(cl:ensure-generic-function 'gps_vE-val :lambda-list '(m))
(cl:defmethod gps_vE-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:gps_vE-val is deprecated.  Use utils-msg:gps_vE instead.")
  (gps_vE m))

(cl:ensure-generic-function 'gps_vD-val :lambda-list '(m))
(cl:defmethod gps_vD-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:gps_vD-val is deprecated.  Use utils-msg:gps_vD instead.")
  (gps_vD m))

(cl:ensure-generic-function 'dvl_vX-val :lambda-list '(m))
(cl:defmethod dvl_vX-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:dvl_vX-val is deprecated.  Use utils-msg:dvl_vX instead.")
  (dvl_vX m))

(cl:ensure-generic-function 'dvl_vY-val :lambda-list '(m))
(cl:defmethod dvl_vY-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:dvl_vY-val is deprecated.  Use utils-msg:dvl_vY instead.")
  (dvl_vY m))

(cl:ensure-generic-function 'dvl_vZ-val :lambda-list '(m))
(cl:defmethod dvl_vZ-val ((m <gps_dvl_ins_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:dvl_vZ-val is deprecated.  Use utils-msg:dvl_vZ instead.")
  (dvl_vZ m))
