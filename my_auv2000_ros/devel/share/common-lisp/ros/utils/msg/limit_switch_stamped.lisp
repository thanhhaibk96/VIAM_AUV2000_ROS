...
(cl:defmethod cl:initialize-instance :after ((m <limit_switch_stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'limit_switch_stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-msg:<limit_switch_stamped> is deprecated: use utils-msg:limit_switch_stamped instead.")))

(cl:ensure-generic-function 'ls_AtHead-val :lambda-list '(m))
(cl:defmethod ls_AtHead-val ((m <limit_switch_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ls_AtHead-val is deprecated.  Use utils-msg:ls_AtHead instead.")
  (ls_AtHead m))

(cl:ensure-generic-function 'ls_AtTail-val :lambda-list '(m))
(cl:defmethod ls_AtTail-val ((m <limit_switch_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:ls_AtTail-val is deprecated.  Use utils-msg:ls_AtTail instead.")
  (ls_AtTail m))
