...
(cl:defclass <board_arm2_stamped> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (mx28_status
    :reader mx28_status
    :initarg :mx28_status
    :type utils-msg:mx28_stamped
    :initform (cl:make-instance 'utils-msg:mx28_stamped))
   (bms_status
    :reader bms_status
    :initarg :bms_status
   ...
   (pressure_status
    ...
    :type utils-msg:keller_pa3_stamped
    :initform (cl:make-instance 'utils-msg:keller_pa3_stamped))
   (roll_motor_status
...
(cl:defmethod cl:initialize-instance :after ((m <board_arm2_stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'board_arm2_stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-msg:<board_arm2_stamped> is deprecated: use utils-msg:board_arm2_stamped instead.")))
...
(cl:defmethod mx28_status-val ((m <board_arm2_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:mx28_status-val is deprecated.  Use utils-msg:mx28_status instead.")
  (mx28_status m))
...
(cl:defmethod pressure_status-val ((m <board_arm2_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:pressure_status-val is deprecated.  Use utils-msg:pressure_status instead.")
  (pressure_status m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<board_arm2_stamped>)))
  ...
  (cl:format cl:nil "Header header~%mx28_stamped mx28_status~%bms_stamped bms_status~%keller_pa3_stamped pressure_status~%anti_rolling_stamped roll_motor_status~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: utils/mx28_stamped~%float32 position~%float32 speed~%float32 load~%float32 voltage~%float32 temperature~%~%================================================================================~%MSG: utils/bms_stamped~%float32 batteryTotal~%float32 batteryCapacity~%float32 batteryUsed~%float32 batteryPercentage~%float32 batteryCurrent~%float32 baterryVoltage~%~%================================================================================~%MSG: utils/keller_pa3_stamped~%float32 pressure~%float32 temperature~%~%================================================================================~%MSG: utils/anti_rolling_stamped~%float32 kp~%float32 ki~%float32 kd~%float32 angle~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'board_arm2_stamped)))
  "Returns full string definition for message of type 'board_arm2_stamped"
  (cl:format cl:nil "Header header~%mx28_stamped mx28_status~%bms_stamped bms_status~%keller_pa3_stamped pressure_status~%anti_rolling_stamped roll_motor_status~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: utils/mx28_stamped~%float32 position~%float32 speed~%float32 load~%float32 voltage~%float32 temperature~%~%================================================================================~%MSG: utils/bms_stamped~%float32 batteryTotal~%float32 batteryCapacity~%float32 batteryUsed~%float32 batteryPercentage~%float32 batteryCurrent~%float32 baterryVoltage~%~%================================================================================~%MSG: utils/keller_pa3_stamped~%float32 pressure~%float32 temperature~%~%================================================================================~%MSG: utils/anti_rolling_stamped~%float32 kp~%float32 ki~%float32 kd~%float32 angle~%~%~%"))
