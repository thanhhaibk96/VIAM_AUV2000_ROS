...
(cl:defmethod cl:initialize-instance :after ((m <keller_pa3_stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'keller_pa3_stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-msg:<keller_pa3_stamped> is deprecated: use utils-msg:keller_pa3_stamped instead.")))

(cl:ensure-generic-function 'pressure-val :lambda-list '(m))
(cl:defmethod pressure-val ((m <keller_pa3_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader utils-msg:pressure-val is deprecated.  Use utils-msg:pressure instead.")
  (pressure m))
