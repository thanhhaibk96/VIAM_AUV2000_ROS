...
(cl:defmethod cl:initialize-instance :after ((m <Int32Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Int32Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name std_msgs_stamped-msg:<Int32Stamped> is deprecated: use std_msgs_stamped-msg:Int32Stamped instead.")))
