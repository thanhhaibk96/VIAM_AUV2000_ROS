...
(cl:defmethod cl:initialize-instance :after ((m <bms_stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'bms_stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name auv_msgs_stamped-msg:<bms_stamped> is deprecated: use auv_msgs_stamped-msg:bms_stamped instead.")))

(cl:ensure-generic-function 'batteryTotal-val :lambda-list '(m))
(cl:defmethod batteryTotal-val ((m <bms_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader auv_msgs_stamped-msg:batteryTotal-val is deprecated.  Use auv_msgs_stamped-msg:batteryTotal instead.")
  (batteryTotal m))

(cl:ensure-generic-function 'batteryCapacity-val :lambda-list '(m))
(cl:defmethod batteryCapacity-val ((m <bms_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader auv_msgs_stamped-msg:batteryCapacity-val is deprecated.  Use auv_msgs_stamped-msg:batteryCapacity instead.")
  (batteryCapacity m))

(cl:ensure-generic-function 'batteryUsed-val :lambda-list '(m))
(cl:defmethod batteryUsed-val ((m <bms_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader auv_msgs_stamped-msg:batteryUsed-val is deprecated.  Use auv_msgs_stamped-msg:batteryUsed instead.")
  (batteryUsed m))

(cl:ensure-generic-function 'batteryPercentage-val :lambda-list '(m))
(cl:defmethod batteryPercentage-val ((m <bms_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader auv_msgs_stamped-msg:batteryPercentage-val is deprecated.  Use auv_msgs_stamped-msg:batteryPercentage instead.")
  (batteryPercentage m))

(cl:ensure-generic-function 'batteryCurrent-val :lambda-list '(m))
(cl:defmethod batteryCurrent-val ((m <bms_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader auv_msgs_stamped-msg:batteryCurrent-val is deprecated.  Use auv_msgs_stamped-msg:batteryCurrent instead.")
  (batteryCurrent m))

(cl:ensure-generic-function 'baterryVoltage-val :lambda-list '(m))
(cl:defmethod baterryVoltage-val ((m <bms_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader auv_msgs_stamped-msg:baterryVoltage-val is deprecated.  Use auv_msgs_stamped-msg:baterryVoltage instead.")
  (baterryVoltage m))
